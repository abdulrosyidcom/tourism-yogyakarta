			...
			<div class="row">
				...
				<div class="col-lg-8">
					...
					<div class="blog_post_container">
						...
						<!-- Blog Post -->
						<?php foreach( $article_category as $articleCategory ) : ?>
						<div class="blog_post">
							<div class="blog_post_image">
								<img src="<?= base_url('assets/img/article/') . $articleCategory['image']; ?>" alt="">
								<div class="blog_post_date d-flex flex-column align-items-center justify-content-center">
									<div class="blog_post_day"><?= date('d', $articleCategory['date_created']); ?></div>
									<div class="blog_post_month"><?= date('M Y', $articleCategory['date_created']); ?></div>
								</div>
							</div>
							<div class="blog_post_meta">
								<ul>
									<li class="blog_post_meta_item"><a href="">By. <?= $articleCategory['author']; ?></a></li>
									<li class="blog_post_meta_item"><a href=""><?= $articleCategory['category']; ?></a></li>
									<!-- <li class="blog_post_meta_item"><a href="">3 Comments</a></li> -->
								</ul>
							</div>
							<div class="blog_post_title"><a href="<?= base_url('articles/read/') . $articleCategory['url_title']; ?>"><?= $articleCategory['title']; ?></a></div>
							<div class="blog_post_text">
								<p><?= substr($articleCategory['content'], 0, 200); ?></p>
							</div>
							<div class="blog_post_link">
								<a href="<?= base_url('articles/read/') . $articleCategory['url_title']; ?>">read more</a>
							</div>
						</div>
						<?php endforeach; ?>
						...
						<div class="sidebar_list">
							<ul>
								<?php foreach( $categorys as $category ) : ?>
									<li>
										<a href="<?= base_url('articles/category/') . url_title($category['title']); ?>"><?= $category['title']; ?></a>
									</li>
								<?php endforeach; ?>
							</ul>
						</div>
								...
								<?php foreach( $articles as $article ) : ?>
									...
									<li class="latest_post clearfix">
										...
										<div class="latest_post_content">
											<div class="latest_post_title trans_200"><a href="<?= base_url('articles/read/') . $article['url_title']; ?>"><?= substr($article['title'], 0, 21); ?></a></div>
