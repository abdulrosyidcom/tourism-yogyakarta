						...
						<?php foreach( $articles as $article ) : ?>
							...
							<div class="blog_post">
								...
								<div class="blog_post_title">
									<a href="<?= base_url('articles/read/') . $article['url_title']; ?>"><?= $article['title']; ?></a>
								</div>
								<div class="blog_post_text">
									<p><?= substr($article['content'], 0, 250); ?></p>
								</div>
								<div class="blog_post_link">
									<a href="<?= base_url('articles/read/') . $article['url_title']; ?>">read more</a>
								</div>
							</div>
							<?php endif; ?>
						<?php endforeach; ?>
				...
				<div class="col-lg-4 sidebar_col">
					...
					<!-- <div class="sidebar_search">
						<form action="" method="post">
							<input id="sidebar_search_input" name="keyword" type="search" class="sidebar_search_input" placeholder="" required="required">
									...
									<?php if( $article['is_active'] == 'active' ) : ?>
										<li class="latest_post clearfix">
											<div class="latest_post_image">
												<a href="#">
													<img src="<?= base_url('assets/img/article/') . $article['image']; ?>" width="100" class="mr-3" alt="">
												</a>
											</div>
											<div class="latest_post_content">
												<div class="latest_post_title trans_200">
													<a href="<?= base_url('articles/read/') . $article['url_title']; ?>"><?= substr($article['title'], 0, 20); ?></a>
												</div>
